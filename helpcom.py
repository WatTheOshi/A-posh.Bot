...
help_sections = [
...

    {
        "title": "Кража пробок!",
        "commands": [
            ("**&stash**", "Проверить своё хранилище пробок!"),
            ("**&acquire**", "Получить именную пробку! ||Только один раз||"),
            ("**&steal @user usertag**", "Украсть пробку если тот не активен 48 часов! Пример: &steal @Nagel Пробка nagelbi"),
            ("**&trade**", "В планах! :broom:"),
            ("**&bounty**", "В планах! :broom:"),
        ]
    }
